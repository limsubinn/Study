...
################################################################
# This is a generated script based on design: zynq_custom
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set dip_switch_0 [ create_bd_port -dir I dip_switch_0 ]
  ...
  connect_bd_net -net dip_switch_0_1 [get_bd_ports dip_switch_0] [get_bd_pins myip_0/dip_switch]
  connect_bd_net -net myip_0_leds_out [get_bd_ports leds_out_0] [get_bd_pins myip_0/leds_out]
  ...
  connect_bd_net -net push_button_0_1 [get_bd_ports push_button_0] [get_bd_pins myip_0/push_button]
