...
HD_PWD='C:/project_1/project_1.runs/zynq_custom_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_custom_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_custom_auto_pc_1.tcl
