...
HD_PWD='C:/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_custom_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_custom_wrapper.tcl -notrace
