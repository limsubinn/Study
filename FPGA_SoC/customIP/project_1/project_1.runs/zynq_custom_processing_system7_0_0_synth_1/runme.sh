...
HD_PWD='C:/project_1/project_1.runs/zynq_custom_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_custom_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_custom_processing_system7_0_0.tcl
