...
HD_PWD='C:/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_custom_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_custom_wrapper.tcl
