...
HD_PWD='C:/project_1/project_1.runs/zync_gpio_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_gpio_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zync_gpio_axi_gpio_0_0.tcl
