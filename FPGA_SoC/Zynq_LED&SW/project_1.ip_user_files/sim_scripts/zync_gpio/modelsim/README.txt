...
#
# Generated by export_simulation on Wed May 01 11:29:16 +0900 2019
#
################################################################################
...
'-reset_run' switch to the './zync_gpio.sh' script.

./zync_gpio.sh -reset_run
...
./zync_gpio.sh -noclean_files

For more information on the script, please type './zync_gpio.sh -help'.
